...
class User(db.Model):
    ...
    def generate_token(self, user_id):
        ...
        try:
            ...
            # create the byte strig token using the payload and the SECRET key
            ...
            # return an error in strin format if an exception occurs
            return str(e)
...
class Bucketlist(db.Model):
    ...
    @staticmethod
    def get_all(user_id):
        """This method gets all bucketlists for a given user."""
