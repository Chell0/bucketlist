...
def create_app(config_name):
        ...
        if access_token:
            ...
            if not isinstance(user_id, str):
                ...
                if request.method == "POST":
                    ...
                    # GET all bucketlists created by this user
    ...
    def bucketlist_manipulation(id, **kwargs):
        ...
        if access_token:
            # Get the user id related to this acces token
            user_id = User.decode_token(access_token)

            if not isinstance(user_id, str):
                # if the id is not a string(error), we have a user_id
                ...
                # return an error message, telling the user he/she is Unauthorized
                return make_response(jsonify(response)), 401
